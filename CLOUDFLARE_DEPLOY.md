...
# 6. config.js is served (check it has your URL)
curl https://slm-market.sannan.app/config.js
```
...
- [ ] https://slm-market.sannan.app/config.js returns your Supabase URL (not placeholder)
